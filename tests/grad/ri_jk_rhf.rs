...
fn test_nh3_with_arg(policy: &str, uplo: &str) {
    ...
    #[rustfmt::skip]
    let de_ref = vec![
         0.0025853881,  0.0018395848,  0.0010620843,
         0.0026807605, -0.0020655176, -0.0011925272,
        -0.0026330744, -0.0006902976,  0.0014565159,
        -0.0026330742,  0.0009162305, -0.0013260730,
    ];
