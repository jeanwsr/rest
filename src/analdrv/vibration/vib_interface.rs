...
pub fn vibration_analysis_interface(
    ...
    let atm_list = cfg.atm_list.clone().unwrap_or_else(|| (0..mol.natm()).collect_vec());
    ...
    let gau_th = cfg.gau_thermo.then(|| {
        ...
        let tol_pg = cfg.tol_point_group / (1.0 + natm as f64).sqrt();
