...
use crate::ri_tddft::utils::{tddft_occupation_parameters, tddft_occupation_parameters_spin, tddft_get_submatrix_spin, compute_tddft_dipole_matrix, compute_tddft_dipole_matrix_unrestricted};
...
pub fn tddft_main(scf: &mut SCF) -> Result<TddftOutput, String> {
    ...
    let run_spin = |xlet: char, initial_guess: &MatrixFull<f64>|
        ...
        let dipole_matrix = compute_tddft_dipole_matrix(scf_ref, start_mo, occ_size, vir_size, homo, lumo);
