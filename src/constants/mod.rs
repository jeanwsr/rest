...
pub const SPEED_OF_LIGHT: f64 = 299792458.0;    // CODATA 2022, m s^-1, https://physics.nist.gov/cgi-bin/cuu/Value?c

// =========== unit conversion ===================================
pub const CALORIE2J: f64 = 4.184;                           // calorie -> joule, https://en.wikipedia.org/wiki/Calorie
...
pub const BOHR2ANG: f64 = BOHR;                             // bohr -> Angstrom, by definition
pub const AU2DEBYE:f64 = E_CHARGE * BOHR*1e-10 / DEBYE;     // AU -> Debye, derived, 2.541746
pub const HARTREE2J: f64 = 4.359744722206e-18;              // hartree -> joule, CODATA 2022, https://physics.nist.gov/cgi-bin/cuu/Value?Ahr, atomic unit of energy
pub const HARTREE2KJMOL: f64 = HARTREE2J * AVOGADRO / 1000.0;  // hartree -> kJ/mol, derived, 2625.499681768687
pub const HARTREE2KCALMOL: f64 = HARTREE2KJMOL / CALORIE2J; // hartree -> kcal/mol, derived, 627.5094841703362
pub const HARTREE2KCAL: f64 = HARTREE2KCALMOL;              // hartree -> kcal/mol, derived, 627.5094841703362
pub const HARTREE2WAVENUMBERS: f64 = 219474.63136314;       // hartree -> cm^-1, CODATA 2022, https://physics.nist.gov/cgi-bin/cuu/Value?hrminv, hartree-inverse meter relationship
pub const AMU2KG: f64 = 1.66053906892e-27;                  // amu -> kg, CODATA 2022, https://physics.nist.gov/cgi-bin/cuu/Value?ukg, unified atomic mass unit
